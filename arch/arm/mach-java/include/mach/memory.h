...
#define PLAT_PHYS_OFFSET	(CONFIG_BCM_RAM_BASE+CONFIG_BCM_RAM_START_RESERVED_SIZE)
...
/* MM2 APB16*/
#define IO_G8_PHYS		0x3D800000
#define IO_G8_VIRT		\
	(IO_G7_VIRT + IO_G7_SIZE)
#define IO_G8_SIZE		(SZ_1M)

/* ISP2*/
#define IO_G9_PHYS		0x3DA00000
#define IO_G9_VIRT		\
	(IO_G8_VIRT + IO_G8_SIZE)
#define IO_G9_SIZE		(SZ_1M)
...
#define IO_PHYS_TO_VIRT(n) (					\
		...
		IO_BETWEEN((n), IO_G8_PHYS, IO_G8_SIZE) ?	\
			IO_XLATE((n), IO_G8_PHYS, IO_G8_VIRT) :	\
		IO_BETWEEN((n), IO_G9_PHYS, IO_G9_SIZE) ?	\
			IO_XLATE((n), IO_G9_PHYS, IO_G9_VIRT) :	\
		0)
...
#define IO_VIRT_TO_PHYS(n) (					\
		...
		IO_BETWEEN((n), IO_G8_VIRT, IO_G8_SIZE) ?	\
			IO_XLATE((n), IO_G8_VIRT, IO_G8_PHYS) :	\
		IO_BETWEEN((n), IO_G9_VIRT, IO_G9_SIZE) ?	\
			IO_XLATE((n), IO_G9_VIRT, IO_G9_PHYS) :	\
		0)
